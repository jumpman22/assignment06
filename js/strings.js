...
//window.alert("You have " + answer.length + " characters in your name.");
...
//var letter = window.prompt("Pick a number");
//window.alert(name[letter]);
...
//found = text.search(word);
//if(found !== -1) {
//    window.alert("Your word was found at position " + found);
//} else {
//    window.alert("Your word was not found.");
//}
